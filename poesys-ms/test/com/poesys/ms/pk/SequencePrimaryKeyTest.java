...
/**
 * Tests the SequencePrimaryKey messaging DTO
 * 
 * @author Robert J. Muller
 */
public class SequencePrimaryKeyTest {

  private static final String CLASS_NAME = "com.poesys.db.dto.TestNatural";

  /**
   * Test method for {@link com.poesys.ms.pk.SequencePrimaryKey#getName()}.
   */
  @Test
  public void testGetName() {
    String name = "sequenceColumn";
    BigInteger value = new BigInteger("20");
    SequencePrimaryKey key = new SequencePrimaryKey(name, value, CLASS_NAME);
    assertTrue("name not stored as class member", name.equals(key.getName()));
  }

  /**
   * Test method for {@link com.poesys.ms.pk.SequencePrimaryKey#getValue()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link com.poesys.ms.pk.SequencePrimaryKey#getColumnValues()}.
   */
  @Test
  ...
  /**
   * Test method for {@link com.poesys.ms.pk.SequencePrimaryKey#toString()}.
   */
  @Test
  public void testToString() {
    ...
    assertTrue("toString generates wrong value: " + key.toString(),
               key.toString().equals("[Sequence id " + name + "=" + value + "]"));
  }
}
